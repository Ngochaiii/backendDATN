...
@section('content')
    @php
        ...
        {
            $duration = \Carbon\Carbon::createFromTimestampUTC($totalSeconds);
            $hours = $duration->hour;
                                    ...
                                    <div class="row">
                                        @foreach ($events as $item)
                                            @php
                                                if ($item->type == 0) {
                                                    ...
                                                    $timeArray = convertSecondsToTime($totalSeconds);
                                                }
                                            @endphp
                                                ...
                                                <div class="single-timeline-content d-flex wow fadeInLeft"
                                                    ...
                                                    <div class="timeline-text">
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            @if ($item->date != 0)
                                                                <p> :
                                                                    {{ \Carbon\Carbon::createFromTimestamp($item->date)->toDateString() }}
                                                                </p>
                                                            @elseif($item->day_of_week != 0)
                                                                <p>Thứ {{ $item->day_of_week }}</p>
                                                            @elseif($item->type == 0)
                                                                <p>{{ "{$timeArray['hours']} Giờ :  {$timeArray['minutes']} Phút" }}
                                                                </p>
                                                            @endif
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div class="single-timeline-content d-flex wow fadeInLeft" data-wow-delay="0.7s"
                                                ...
                                                <div class="timeline-icon"><i class="fa fa-address-book"
                                                        aria-hidden="true"></i>
                                                </div>
                                                <div class="timeline-text">
                                ...
                                <div class="single-timeline-area">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div class="single-timeline-content d-flex wow fadeInLeft" data-wow-delay="0.7s"
                                                style="visibility: visible; animation-delay: 0.7s; animation-name: fadeInLeft;">
                                                <div class="timeline-icon"><i class="fa fa-picture-o"
                                                        aria-hidden="true"></i>
                                                </div>
                                                <div class="timeline-text">
