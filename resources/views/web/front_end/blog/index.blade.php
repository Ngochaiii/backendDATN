                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="single-blog-post">
                                ...
                                <div class="blog-post-content">
                                    ...
                                    <a href="#" class="read-more-btn">Read More <i data-feather="arrow-right"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-blog-post">
                                <div class="blog-image">
                                    <a href="#">
                                        <img src="{{ asset('assets/front_end/assets/img/blog-image/4.jpg') }}" alt="image">
                                    </a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-blog-post">
                                <div class="blog-image">
                                    <a href="#">
                                        <img src="{{ asset('assets/front_end/assets/img/blog-image/5.jpg') }}" alt="image">
                                    </a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-blog-post">
                                <div class="blog-image">
                                    <a href="#">
                                        <img src="{{ asset('assets/front_end/assets/img/blog-image/6.jpg') }}" alt="image">
                                    </a>
