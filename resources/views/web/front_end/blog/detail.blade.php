                    ...
                    <div class="blog-details-desc">
                        ...
                        <div class="article-content">
                            <div class="entry-meta">
                                <ul>
                                    <li><i data-feather="clock"></i> <a href="#">{{$blog->created_at}}</a></li>
                                    <li><i data-feather="user"></i> <a href="#">{{Auth::user()->name}}</a></li>
                                </ul>
                            </div>
                            ...
                            <ul class="wp-block-gallery columns-3">
                                <li class="blocks-gallery-item">
                                    <figure>
                                        <img src="{{asset('assets/front_end/assets/img/blog-image/8.jpg')}}" alt="image">
                                    </figure>
                                </li>

                                <li class="blocks-gallery-item">
                                    <figure>
                                        <img src="{{asset('assets/front_end/assets/img/blog-image/7.jpg')}}" alt="image">
                                    </figure>
                                </li>

                                <li class="blocks-gallery-item">
                                    <figure>
                                        <img src="{{asset('assets/front_end/assets/img/blog-image/9.jpg')}}" alt="image">
                                    </figure>
                                </li>
                            </ul>
                            ...
                            <ol class="comment-list">
                                    ...
                                    <article class="comment-body">
                                        <footer class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img src="{{asset('assets/front_end/assets/img/client-image/1.j')}}pg" class="avatar" alt="image">
                                    ...
                                    <ol class="children">
                                        <li class="comment">
                                            <article class="comment-body">
                                                <footer class="comment-meta">
                                                    <div class="comment-author vcard">
                                                        <img src="{{asset('assets/front_end/assets/img/client-image/2.j')}}pg" class="avatar"
                                                            alt="image">
                                        ...
                                        <ol class="children">
                                            <li class="comment">
                                                <article class="comment-body">
                                                    <footer class="comment-meta">
                                                        <div class="comment-author vcard">
                                                            <img src="{{asset('assets/front_end/assets/img/client-image/3.j')}}pg" class="avatar"
                                                                alt="image">
                                ...
                                <li class="comment">
                                    <article class="comment-body">
                                        <footer class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img src="{{asset('assets/front_end/assets/img/client-image/4.j')}}pg" class="avatar" alt="image">
                                    ...
                                    <ol class="children">
                                        <li class="comment">
                                            <article class="comment-body">
                                                <footer class="comment-meta">
                                                    <div class="comment-author vcard">
                                                        <img src="{{asset('assets/front_end/assets/img/client-image/5.j')}}pg" class="avatar"
                                                            alt="image">
                        ...
                        <div class="widget widget_startp_posts_thumb">
                            ...
                            <article class="item">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="title usmall"><a href="#">I Used The Web For A Day On A 50 MB
                                            Budget</a></h4>
                                </div>
                            ...
                            <article class="item">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="title usmall"><a href="#">How To Create A Responsive Popup
                                            Gallery?</a></h4>
                                </div>
